      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-14 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm">
            ...
            <li><Link href="/devnet" className="text-muted hover:text-ink transition-colors">Devnet</Link></li>
            <li><a href="https://network.crypsurance.io" className="text-muted hover:text-ink transition-colors">Verifier Network</a></li>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm">
            ...
            <li>
              <a href="https://t.me/suretytoken_official" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-ink transition-colors">
                Telegram
              </a>
            </li>
            <li>
